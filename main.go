...
func runMcmc() {
	...
	var impl = mcmc.NewParImpl(conf, initializer, nil, func(mcmc.Conf) mcmc.Distrib { return distrib })
	...
	log.Println(fmt.Sprintf("TotalLoss : %v", centers.TotalLoss(data, space, conf.Norm)))
