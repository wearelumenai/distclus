...
func TestMCMC_Initialization(t *testing.T) {
	var conf = mcmcConf
	conf.McmcIter = 0
	var algo = mcmc.NewSeqMCMC(conf, distrib, kmeans.GivenInitializer, nil)
...
func TestMCMC_RunSyncKMeansPP(t *testing.T) {
	...
	var algo = mcmc.NewSeqMCMC(conf, distrib, kmeans.KMeansPPInitializer, nil)
...
func TestMCMC_AcceptRatio(t *testing.T) {
	var algo = mcmc.NewSeqMCMC(mcmcConf, distrib, kmeans.GivenInitializer, nil)
	zetest.PushAndRunSync(algo)
...
func TestMCMC_ConfErrorIter(t *testing.T) {
	...
	var conf = mcmcConf
	conf.McmcIter = -10
	mcmc.NewSeqMCMC(conf, distrib, kmeans.KMeansPPInitializer, nil)
}
